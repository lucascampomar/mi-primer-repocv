...
let wordexcel = document.getElementById("wordpress");
...
//Cantidad de barras
//utilizo un arreglo, cada posiciòn pertenece a un elemento
...
//barras particulares con la cantidad a utilizar
function pintarBarra(id_barra, cantidad, indice, interval){
    contadores[indice]++;
    x = contadores[indice];
    if(x < cantidad){
        let elementos = id_barra.getElementsByClassName("e");
        elementos[x].style.backgroundColor = "#409494";
    }else{
